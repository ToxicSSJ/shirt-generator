...
set JAVA_VERSION=17
set MAIN_JAR=shirt-%PROJECT_VERSION%.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\sh\toxic\shirt\ShirtApplication.class > temp.txt
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --name shirt-generator ^
  --main-class sh.toxic.shirt.ShirtApplication ^
  --main-jar %MAIN_JAR% ^
  --java-options -Xmx2048m ^
  --runtime-image target/java-runtime ^
  --icon src/main/logo/windows/app.ico ^
